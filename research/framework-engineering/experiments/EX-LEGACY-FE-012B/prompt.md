# Independent Evaluation — EX-LEGACY-FE-012B vlegacy-import-1.0
...
**Question:** What results were recorded by FE-012B Primitive Synthesis?

**Primary hypothesis:** FE-012B

**Claim under test:** Historical claim retained without reinterpretation during migration.

## Permitted inputs

- `research/experiments/FE-012B-primitive-synthesis/README.md` (EX-LEGACY-FE-012B-README.md)
- `research/experiments/FE-012B-primitive-synthesis/protocol.md` (EX-LEGACY-FE-012B-protocol.md)
- `research/experiments/FE-012B-primitive-synthesis/analysis-plan.md` (EX-LEGACY-FE-012B-analysis-plan.md)
