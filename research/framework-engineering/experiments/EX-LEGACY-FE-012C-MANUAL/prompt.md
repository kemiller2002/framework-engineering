# Independent Evaluation — EX-LEGACY-FE-012C-MANUAL vlegacy-import-1.0
...
**Question:** What results were recorded by FE-012C Manual Multi-Model Replication?

**Primary hypothesis:** FE-012C

**Claim under test:** Historical claim retained without reinterpretation during migration.

## Permitted inputs

- `research/experiments/FE-012C-manual-replication/README.md` (EX-LEGACY-FE-012C-MANUAL-README.md)
- `research/experiments/FE-012C-manual-replication/protocol.md` (EX-LEGACY-FE-012C-MANUAL-protocol.md)
- `research/experiments/FE-012C-manual-replication/packet-index.md` (EX-LEGACY-FE-012C-MANUAL-packet-index.md)
