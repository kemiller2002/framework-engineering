# Independent Evaluation — EX-LEGACY-ECR-000002 vlegacy-import-1.0
...
**Question:** What results were recorded by ECR-000002 Recognition Sensitivity?

**Primary hypothesis:** H013, H003, H015

**Claim under test:** Historical claim retained without reinterpretation during migration.

## Permitted inputs

- `research/evidence-runs/ECR-000002-recognition-sensitivity/README.md` (EX-LEGACY-ECR-000002-README.md)
- `research/evidence-runs/ECR-000002-recognition-sensitivity/pre-registration.md` (EX-LEGACY-ECR-000002-pre-registration.md)
- `research/evidence-runs/ECR-000002-recognition-sensitivity/analysis-plan.md` (EX-LEGACY-ECR-000002-analysis-plan.md)
