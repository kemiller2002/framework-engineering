# Independent Evaluation — EX-LEGACY-FE-011A vlegacy-import-1.0
...
**Question:** What results were recorded by FE-011A LLM Blind Pilot?

**Primary hypothesis:** FE-011A

**Claim under test:** Historical claim retained without reinterpretation during migration.

## Permitted inputs

- `research/experiments/FE-011A-llm-blind-pilot/README.md` (EX-LEGACY-FE-011A-README.md)
- `research/experiments/FE-011A-llm-blind-pilot/protocol.md` (EX-LEGACY-FE-011A-protocol.md)
- `research/experiments/FE-011A-llm-blind-pilot/analysis-plan.md` (EX-LEGACY-FE-011A-analysis-plan.md)
