# Independent Evaluation — EX-LEGACY-ECR-000001 vlegacy-import-1.0
...
**Question:** What results were recorded by ECR-000001 Multi-Layer Procedural Representation?

**Primary hypothesis:** H003, H012, H013, H015

**Claim under test:** Historical claim retained without reinterpretation during migration.

## Permitted inputs

- `research/evidence-runs/ECR-000001-multi-layer-procedural-representation/README.md` (EX-LEGACY-ECR-000001-README.md)
- `research/evidence-runs/ECR-000001-multi-layer-procedural-representation/pre-registration.md` (EX-LEGACY-ECR-000001-pre-registration.md)
- `research/evidence-runs/ECR-000001-multi-layer-procedural-representation/analysis-plan.md` (EX-LEGACY-ECR-000001-analysis-plan.md)
