---
id: DOC-FE-EXPERIMENT-ROADMAP-1.0-FRONTIER
title: "Experiment portfolio roadmap frontier"
status: active
generated: 2026-07-28
source_artifact_id: "FE-EXPERIMENT-ROADMAP-1.0"
source_status: "current-pilot"
analysis_unit: EXPERIMENT-SYSTEM
---

# Experiment portfolio roadmap: document frontier

## Source and coverage

- **Source:** [`research/framework-engineering/experiments/roadmap.md`](../../../research/framework-engineering/experiments/roadmap.md)
- **Canonical ID:** `FE-EXPERIMENT-ROADMAP-1.0`
- **Lifecycle status:** `current-pilot`
- **Artifact type:** `research-document`
- **Version:** 1.0
- **Confidence:** not declared
- **Inclusion rule:** eligible lifecycle status: current-pilot
...
- **Declared headings inspected:** Experiment portfolio roadmap.
